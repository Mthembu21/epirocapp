...
//     // ==================== REPLACE EVERYTHING FROM dailyData ONWARDS ====================

//     // Daily productivity data with robust fallback
//     const dailyData = useMemo(() => {
//         console.log('🔍 Debug dailyData calculation:', {
//             selectedTechnician,
//             monthlySummaries: Array.isArray(monthlySummaries) ? monthlySummaries.length : 'not-array',
//             filteredEntriesCount: filteredEntries.length
//         });

//         // 1. Use API data if available
//         if (Array.isArray(monthlySummaries) && monthlySummaries.length > 0) {
//             console.log('🔍 Using API daily productivity data');
...
//             } else {
//                 // Single technician
//                 const techData = monthlySummaries;
//                 return techData
//                     .map(day => ({
//                         date: format(new Date(day.date || day.fullDate), 'dd'),
//                         fullDate: format(new Date(day.date || day.fullDate), 'MMM dd'),
...
//         // 2. Fallback: Calculate from filteredEntries
//         console.log('🔍 Using fallback calculation from filteredEntries');
...
//             console.log('🔍 Final fallback result for "all":', result.length, 'days');
//             return result;
//         } 
//         else {
...
//                 {/* Hours Comparison - Allocated vs Utilized */}
    ...
    const dailyData = useMemo(() => {
        ...
        if (selectedTechnician === 'all') {
            ...
            filteredEntries.forEach(entry => {
                ...
                allDaily[key].productiveHours += entry.is_idle ? 0 : h;
            ...
            techEntries.forEach(entry => {
                ...
                dailyMap[key].productiveHours += entry.is_idle ? 0 : h;
